...
label = Label(window, text='Please enter the language you want to identify: ', font=(font, 14))
label.config(background=background)
label.pack(pady=20)

e = Entry(window)
e.config(width=50, background=background)
e.pack(pady=20)
e.focus_force()
...
separator.place(width=1000, rely=0.5)
